...
void Player::Update() {
	...
	if (collisionMapInfo.hitWall) {
		velocity_.x*=(1.0f-kAttennuationWall);
	}
	//接地判定
...
void Player::CheckMapCollisionUp(CollisionMapInfo& info) {
	...
	mapChipNext=mapChipField_->GetMapChipTypeByIndex(indexSet.xIndex, indexSet.yIndex+1);
	if (mapChipType == MapChipType::kBlock&&mapChipNext!=MapChipType::kBlock) {
		hit = true;
	}
	// 右上点の判定
...
void Player::CheckMapCollisionRight(CollisionMapInfo& info) {
	...
	indexSet = mapChipField_->GetMapChipIndexSetByPosition(positionsNew[kRighttop]);
	mapChipType = mapChipField_->GetMapChipTypeByIndex(indexSet.xIndex, indexSet.yIndex);
	mapChipNext=mapChipField_->GetMapChipTypeByIndex(indexSet.xIndex-1, indexSet.yIndex);
	if (mapChipType == MapChipType::kBlock&&mapChipNext!=MapChipType::kBlock) {
		hit = true;
	}
	// 右下点の判定
